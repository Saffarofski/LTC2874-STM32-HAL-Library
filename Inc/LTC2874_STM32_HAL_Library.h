#ifndef LTC2874_STM32_HAL_Library_H
#define LTC2874_STM32_HAL_Library_H
...
/*			Added functions and values 		*/


typedef struct
{
	 GPIO_TypeDef *CS_GPIO_PORT;             		/*!< The port which connected to SS pin of LTC2874  */

	 uint16_t CS_GPIO_Pin;             		/*!< specifies the port bit which connected to SS pin of LTC2874  */

	 SPI_HandleTypeDef *SPI_Handler;					/*!< specifies the SPI handletypedef  which connected to SPI of LTC2874  */
